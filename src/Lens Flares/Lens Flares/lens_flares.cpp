...
bool LensFlares::checkValidationLayersSupport()
{
...
std::vector<const char*> LensFlares::getRequireExtensions()
{
...
VKAPI_ATTR VkBool32 VKAPI_CALL LensFlares::debugCallback(
...
void LensFlares::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
	createInfo = {};
